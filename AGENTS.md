...
This project is indexed by GitNexus as **spring-native-bookstore** (1320 symbols, 2230 relationships, 30 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
