...
This project is indexed by GitNexus as **spring-native-bookstore** (2070 symbols, 3549 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
