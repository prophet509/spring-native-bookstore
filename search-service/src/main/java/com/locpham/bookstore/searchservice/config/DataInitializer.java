...
public class DataInitializer {
                ...
                repository
                        ...
                        .flatMap(
                                count -> {
                                    if (count > 0) {
                                        log.info(
                                                "ES index already has {} documents, skipping seed",
                                                count);
                                        return Mono.empty();
                                    }
                                    log.info(
                                            "ES index empty, seeding {} sample documents",
                                            SAMPLE_BOOKS.size());
                                    return repository
                                            .saveAll(SAMPLE_BOOKS)
                                            .collectList()
                                            .doOnSuccess(
                                                    docs ->
                                                            log.info(
                        ...
                        .onErrorResume(
                                e -> {
                                    log.warn(
                                            "Could not seed ES index (ES might not be running): {}",
                                            e.getMessage());
                                    return Mono.empty();
                                })
                        .block();
    ...
    private static final List<ElasticsearchBookDocument> SAMPLE_BOOKS =
            List.of(
                    new ElasticsearchBookDocument(
                            "9781617296956",
                    ...
                    new ElasticsearchBookDocument(
                            "9781835085240",
                            "Spring Boot 4 Cookbook",
                            "Alex Antonov",
                            44.99,
                            "Packt"),
                    new ElasticsearchBookDocument(
                            "9781617293153", "Spring in Action", "Craig Walls", 52.99, "Manning"),
                    new ElasticsearchBookDocument(
                            "9781492043458",
                    ...
                    new ElasticsearchBookDocument(
                            "9781835080207",
                            "Java Concurrency in Practice 2E",
                            "Brian Goetz",
                            59.99,
                            "Packt"),
                    new ElasticsearchBookDocument(
                    ...
                    new ElasticsearchBookDocument(
                            ...
                            "O'Reilly"),
                    new ElasticsearchBookDocument(
                            "9781617298929", "Podman in Action", "Daniel Walsh", 49.99, "Manning"),
                    new ElasticsearchBookDocument(
                            "9781484256220",
