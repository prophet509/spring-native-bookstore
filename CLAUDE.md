...
This project is indexed by GitNexus as **spring-native-bookstore** (2068 symbols, 3548 relationships, 65 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
